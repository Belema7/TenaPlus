...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-blue-50 to-emerald-50 flex flex-col items-center justify-center py-8 px-4">
      <section className="w-full max-w-sm bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <Link to="/" className="flex justify-center mb-6">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-gray-900">HealthPlus</span>
          </div>
        </Link>

        {/* Security Badge */}
        <div className="bg-teal-50 border border-teal-200 rounded-lg p-3 mb-4 flex items-center justify-center space-x-2">
        ...
        <div className="border border-gray-200 rounded-lg p-5 bg-white">
          ...
          <p className="text-xs text-gray-600 mb-4">
            By continuing, you agree to HealthPlus's{" "}
        ...
        <div className="relative flex items-center my-6">
          ...
          <span className="shrink mx-4 text-xs text-gray-500 bg-white px-2">New to HealthPlus?</span>
          <div className="grow border-t border-gray-300"></div>
        </div>
        ...
        >
          ...
          <span>{loading.signUp ? "Please wait..." : "Create your HealthPlus account"}</span>
        </button>
        ...
        <div className="mt-6 grid grid-cols-3 gap-3 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            <Shield className="h-4 w-4 text-teal-500 mx-auto mb-1" />
            <p className="text-xs text-gray-600">Secure Data</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-3">
            <Stethoscope className="h-4 w-4 text-blue-500 mx-auto mb-1" />
            <p className="text-xs text-gray-600">Medical Grade</p>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <p className="text-xs text-gray-500 text-center mt-4">
            © 2024 HealthPlus. Your health, our priority.
          </p>
        </div>
